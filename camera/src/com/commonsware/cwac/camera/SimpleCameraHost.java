...
public class SimpleCameraHost implements CameraHost {
    ...
    public SimpleCameraHost(Context _ctxt,String imageName) {
        this.ctxt=_ctxt.getApplicationContext();
    ...
    private void initPhotoDirectory() {
        //photoDirectory = new File(Environment.getExternalStorageDirectory(), "ClickAccounting/Pictures");
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.FROYO) {
            photoDirectory = ctxt.getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS);
        }
    ...
    private void initVideoDirectory() {
        videoDirectory = new File(Environment.getExternalStorageDirectory()+ "/CultureDock/Videos");
        //videoDirectory = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES), "CultureDock/Videos");
    }
