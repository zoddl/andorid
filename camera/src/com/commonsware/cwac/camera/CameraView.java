...
//Todo
                  /*int size =camera.getParameters().getSupportedPreviewSizes().size();

                  if(size>1)
                  previewParams.setPreviewSize(camera.getParameters().getSupportedPreviewSizes().get(size-1).width,camera.getParameters().getSupportedPreviewSizes().get(size-1).height);*/
