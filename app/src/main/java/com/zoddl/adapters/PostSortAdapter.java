 ...
 */
public class PostSortAdapter  extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PostSortAdapter(Context context) {
    ...
    public PostSortAdapter(Context context,boolean flag) {
        this.context = context;
        this.data = new ArrayList<>();
        this.flag = flag;
    }
            ...
            case ITEM:
                ...
                holder.binding.tvSeeAll.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        ((HomeActivity)context).callPostSortFragment(data.get(i).getPrimeName()+" ("+data.get(i).getCount()+")"
                                ,data.get(i).getPrimaryTag()
                                ,data.get(i).getDate());

                        ((HomeActivity) context).onDrawerItemSelected(null, AppConstant.FRAGMENT_POST);
                    }
                });
