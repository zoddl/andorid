package com.zoddl.widgets.customgroupview;
...
public class PresetValueButton extends RelativeLayout implements RadioCheckable {
    ...
    private void parseAttributes(AttributeSet attrs) {
        ...
        try {
            ...
            mValueTextColor = a.getColor(R.styleable.PresetValueButton_presetButtonValueTextColor, resources.getColor(R.color.colorBlack));
    ...
    protected void inflateView() {
        ...
        mUnitImageView = (ImageView) findViewById(R.id.text_view_unit);
        mInitialBackgroundDrawable = getBackground();
    }

    protected void bindView() {
        if (mValueTextColor != DEFAULT_TEXT_COLOR) {
            mUnitImageView.setVisibility(GONE);
        }
        if (mValueTextColor != DEFAULT_TEXT_COLOR) {
    ...
    public void setCheckedState() {
       // setBackgroundResource(R.drawable.background_shape_preset_button__pressed);
        ...
        mUnitImageView.setVisibility(VISIBLE);
        mUnitImageView.setBackgroundResource(R.drawable.icon47);
    }
