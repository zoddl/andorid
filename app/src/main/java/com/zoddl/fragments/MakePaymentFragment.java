...
import com.zoddl.R;
import com.zoddl.databinding.FragmentMakeApaymentBinding;
...
public class MakePaymentFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.fragment_make_apayment, container, false);
    ...
    public void onResume() {
        ...
        binding.faqWebview.loadUrl(UrlConstants.ZODDL_PAYMENT_LINK);
    }
    ...
    public String getTagName() {
        return MakePaymentFragment.class.getSimpleName();
    }
}
