 ...
 */
public class DocumentFragment extends BaseFragment implements OnEventListenerTollbar {
    ...
    List<PrimaryTagTypeModel> primarytagtype = new ArrayList<>();
    List<SecondaryTag> secondarytagtype = new ArrayList<>();
    List<TaglistItem> taglistItems = new ArrayList<>();

    GalleryTagAdapter1 tagAdapter1;
    GalleryTagAdapter2 tagAdapter2;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ((HomeActivity) getActivity()).setOnEventListenerTollbar(DocumentFragment.this);
    ...
    private void setRecyclerView() {
        tagAdapter1 = new GalleryTagAdapter1(getContext(), primarytagtype);
        binding.rvTag1.setLayoutManager(new LinearLayoutManager(context, LinearLayoutManager.HORIZONTAL, false));
        binding.rvTag1.setAdapter(tagAdapter1);

        tagAdapter1.setItemClickListener(new GalleryTagAdapter1.OnItemClickListener() {
            @Override
        ...
        tagAdapter2 = new GalleryTagAdapter2(getContext(), secondarytagtype);
        binding.rvTag2.setLayoutManager(new LinearLayoutManager(context, LinearLayoutManager.HORIZONTAL, false));
        binding.rvTag2.setAdapter(tagAdapter2);

        tagAdapter2.setItemClickListener(new GalleryTagAdapter2.OnItemClickListener() {
            @Override
            public void onItemClick(View v, int position) {
    ...
    public void getprimarytag() {
        Response.Listener<String> stringListener = new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                //Log.e("Primary_Tag_Response", response);
                try {
        ...
        Response.ErrorListener errorListener = new Response.ErrorListener() {
            ...
            public void onErrorResponse(VolleyError error) {
                //Log.e("Primary_Tag_Error", error.toString());
            }
        };
        Map<String, String> params = new HashMap<>();
        params.put("Authtoken", prefManager.getKeyAuthtoken());
        //Log.e("token", params.toString());
        VolleyApiRequest request = new VolleyApiRequest(UrlConstants.ZODDL_DOC_PRIMARY_TAG, params, stringListener, errorListener);
    ...
    public void getsecondarytag() {
        ...
        Response.Listener<String> stringListener = new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
               // Log.e("Secondary_Tag_Response", response);
        ...
        Response.ErrorListener errorListener = new Response.ErrorListener() {
            ...
            public void onErrorResponse(VolleyError error) {
                // progressDialog.dismiss();
                //Log.e("Secondary_Tag_Error", error.toString());
            }
        };
        Map<String, String> params = new HashMap<>();
        params.put("Authtoken", prefManager.getKeyAuthtoken());
        VolleyApiRequest request = new VolleyApiRequest(UrlConstants.ZODDL_DOC_SECONDARY_TAG, params, stringListener, errorListener);
        Volley.newRequestQueue(getActivity()).add(request);
    }
    ...
    public void getAllDetailsGallery() {
        ...
        Response.Listener<String> stringListener = new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
               // Log.e("Gallery_Tag_Response", response);
                try {
                    JSONObject object = new JSONObject(response);
                    if (object.getInt("ResponseCode") == 200) {
        ...
        Response.ErrorListener errorListener = new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
               // Log.e("Gallery_Tag_Error", error.toString());

            }
        };
        Map<String, String> params = new HashMap<>();
        params.put("Authtoken", prefManager.getKeyAuthtoken());
        VolleyApiRequest request = new VolleyApiRequest(UrlConstants.ZODDL_DOC_GALLERY_TAG, params, stringListener, errorListener);
        Volley.newRequestQueue(getActivity()).add(request);
    }
    ...
    private void setLocalInItData() {
        ...
        if (obj.size() != 0) {
            ...
            for (int i = 0; i < obj.size(); i++) {
                if (obj.get(i).getTypeOfFile().equalsIgnoreCase(_DOCUMENT)){
    ...
    public String getTagName() {
        return DocumentFragment.class.getSimpleName();
    }

    @Override
    public void onEvent(String str, int pos) {
        ...
        switch (pos) {
            ...
            case HOME_TOLLBAR_SEARCH_EVENT:
                ...
                return;
           /* case HOME_TOLLBAR_ADD_BUTTON:
                showDialog(_MANUAL_DOCUMENT, "", "");
                return;*/
            //case HOME_TOLLBAR_DOC_BUTTON:
               /* try {
                    ...
                    e.printStackTrace();
                    showAlertDialog(getString(R.string.app_name), "Unable to open file picker.");
                }*/
               // initiatePopupWindow();
                //return;
        ...
        mainAdapter = new GalleryMainAdapter(context, taglistItems);
        binding.rvMainGallery.setAdapter(mainAdapter);
        mainAdapter.notifyDataSetChanged();
