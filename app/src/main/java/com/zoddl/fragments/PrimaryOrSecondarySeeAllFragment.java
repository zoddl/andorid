 ...
 */
public class PrimaryOrSecondarySeeAllFragment extends BaseFragment implements PaginationAdapterCallback {
    ...
    private void setRecyclerView() {
        ...
        /*tagMainAdapter = new PostSortAdapter(context,payLoad,true);
        ...
        tagMainAdapter = new PostSortAdapter(getContext(),true);
    ...
    public void loadFirstPage() {
        ...
        String url = UrlConstants.ZODDL_GALLERY_TAG_BASED_ON_PRIMARY_SECONDARY_TAG;
        String fragName = ((HomeActivity) getActivity()).getFragmentName();
        if (fragName.equalsIgnoreCase(_DOCUMENT)){
            url = UrlConstants.ZODDL_DOC_TAG_BASED_ON_PRIMARY_SECONDARY_TAG;
        }

        Map<String, String> params = new HashMap<>();
        params.put("Authtoken", prefManager.getKeyAuthtoken());
        params.put("Primary_Tag",primaryTagId);
        params.put("Secondary_Tag",primaryDate);
