...
import com.zoddl.R;
import com.zoddl.databinding.FragmentFaqsBinding;
...
public class FAQFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.fragment_faqs, container, false);
    ...
    public void onResume() {
        ...
        binding.faqWebview.loadUrl(UrlConstants.ZODDL_MENU_FAQ);
    }
}
